...
#define CHECK_TRANSPORT(transport) (transport != KVS_SOCKET_PROTOCOL_NONE \
                                    ? (transport == KVS_SOCKET_PROTOCOL_TCP ? ICE_TRANSPORT_TYPE_TCP : ICE_TRANSPORT_TYPE_UDP) \
                                    : "none")
